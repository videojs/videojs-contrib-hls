...
QUnit.test('starts with no expired time', function(assert) {
...
function(assert) {
  ...
  this.requests.pop().respond(200, null,
                              ...
                              '#EXTINF:10,\n' +
                              '4.ts\n');
  assert.equal(loader.expired_, 0, 'expired one segment');
});

QUnit.test('increments expired seconds after a segment is removed', function(assert) {
  let loader = new PlaylistLoader('live.m3u8', this.fakeHls);
  ...
  this.requests.pop().respond(200, null,
                              ...
                              '#EXTINF:10,\n' +
                              '4.ts\n');
  assert.equal(loader.expired_, 10, 'expired one segment');
});

QUnit.test('increments expired seconds after a discontinuity', function(assert) {
  let loader = new PlaylistLoader('live.m3u8', this.fakeHls);
  ...
  this.requests.pop().respond(200, null,
                              ...
                              '#EXTINF:4,\n' +
                              '2.ts\n');
  assert.equal(loader.expired_, 13, 'no expirations after the discontinuity yet');
  ...
  this.requests.pop().respond(200, null,
                              ...
                              '#EXTINF:10,\n' +
                              '3.ts\n');
  assert.equal(loader.expired_, 17, 'tracked expiration across the discontinuity');
});
...
function(assert) {
  ...
  this.requests.pop().respond(200, null,
                              ...
                              '#EXTINF:7,\n' +
                              '3.ts\n');
  assert.equal(loader.expired_, 4 + 5 + 6, 'tracked multiple expiring discontinuities');
});
