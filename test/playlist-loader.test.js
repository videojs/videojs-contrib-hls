...
QUnit.test('can get media index by playback position for non-live videos', function() {
  ...
  QUnit.equal(
    loader.getMediaIndexForTime_(-1),
    0,
  ...
  QUnit.equal(
    loader.getMediaIndexForTime_(22),
    2,
...
function() {
  ...
  QUnit.equal(
    loader.getMediaIndexForTime_(0),
    -1,
    'the lowest returned value is  negative one'
  );
  QUnit.equal(
    loader.getMediaIndexForTime_(45),
    -1,
    'expired content returns negative one'
  );
  QUnit.equal(
    loader.getMediaIndexForTime_(75),
    -1,
    'expired content returns  negative one'
  );
  QUnit.equal(
    loader.getMediaIndexForTime_(50 + 100),
    0,
    'calculates the earliest available position'
  );
  QUnit.equal(
    loader.getMediaIndexForTime_(50 + 100 + 2),
    0,
  ...
  QUnit.equal(
    loader.getMediaIndexForTime_(50 + 100 + 4),
    1,
    'calculates within the second segment'
  );
  QUnit.equal(
    loader.getMediaIndexForTime_(50 + 100 + 4.5),
    1,
    'calculates within the second segment'
  );
  QUnit.equal(
    loader.getMediaIndexForTime_(50 + 100 + 6),
    1,
    'calculates within the second segment'
  );
});
...
QUnit.test('prefers precise segment timing when tracking expired time', function() {
  ...
  QUnit.equal(
    loader.getMediaIndexForTime_(149),
    0,
  ...
  QUnit.equal(
    loader.getMediaIndexForTime_(150 + 4 + 1),
    0,
