...
QUnit.test('stats are reset on each new source', function(assert) {
  ...
  assert.equal(this.player.tech_.hls.stats.mediaBytesTransferred, 16, 'stat is set');
  this.player.src({
...
QUnit.test('starts downloading a segment on loadedmetadata', function(assert) {
  ...
  // verify stats
  assert.equal(this.player.tech_.hls.stats.mediaBytesTransferred, 16, '16 bytes');
...
QUnit.test('Allows overriding the global beforeRequest function', function(assert) {
  ...
  // verify stats
  assert.equal(this.player.tech_.hls.stats.mediaBytesTransferred, 16, 'seen above');
...
QUnit.test('stats are reset on dispose', function(assert) {
  ...
  assert.equal(hls.stats.mediaBytesTransferred, 16, 'stat is set');
  hls.dispose();
...
QUnit.test('downloads additional playlists if required', function(assert) {
  ...
  assert.equal(hls.stats.mediaBytesTransferred, 16, '16 bytes');
