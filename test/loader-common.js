...
export const LoaderCommonFactory = (LoaderConstructor,
  ...
  QUnit.module('Loader Common', function(hooks) {
    ...
    QUnit.test('doesn\'t abort segment requests for one segment duration post-seek',
    function(assert) {
      const playlist1 = playlistWithDuration(60, { uri: 'playlist1.m3u8' });
      const playlist2 = playlistWithDuration(60, { uri: 'playlist2.m3u8' });
      const playlist3 = playlistWithDuration(60, { uri: 'playlist3.m3u8' });
      const playlist4 = playlistWithDuration(60, { uri: 'playlist4.m3u8' });
      const xhrOptions = {
        timeout: 15000
      };
      let bandwidthupdates = 0;
